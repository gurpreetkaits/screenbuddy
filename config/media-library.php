...
return [
     ...
     */
    'max_file_size' => 1024 * 1024 * 1024 * 10, // 10GB (supports 1+ hour recordings)
     ...
     * dependency.
     */
    'ffmpeg_path' => env('FFMPEG_BINARIES', '/usr/local/bin/ffmpeg'),
    'ffprobe_path' => env('FFPROBE_BINARIES', '/usr/local/bin/ffprobe'),
